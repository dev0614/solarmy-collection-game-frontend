...
export const LeaderboardState = (props: {
    ...
    return (
        <div className="dashboard-box" style={{ boxShadow: "none" }}>
            <div className="dashboard-box-header" onClick={() => props.router.push("/leaderboard-demo")}>
...
export const BattalionDashboardBox = (props: {
    ...
    return (
        <div className="dashboard-box">
            <div className="dashboard-box-header" onClick={() => props.router.push("/battalion-demo")}>
            ...
            <div className="dashboard-tabs">
                <button className={topTab === "all" ? "btn-tab active" : "btn-tab"} onClick={() => setTopTab("all")}>all</button>
                <button className={topTab === "2d" ? "btn-tab active" : "btn-tab"} onClick={() => setTopTab("2d")}>2d</button>
                <button className={topTab === "3d" ? "btn-tab active" : "btn-tab"} onClick={() => setTopTab("3d")}>3d</button>
            </div>
